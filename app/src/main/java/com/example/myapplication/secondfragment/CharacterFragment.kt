...
class CharacterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.character.observe(viewLifecycleOwner) {
            ...
            binding.textView5.text = it.species
            binding.textView6.text = it.gender
            binding.textView7.text = it.status
            binding.textView8.text = it.location.name
            binding.textView9.text = it.episode.size.toString()
        }
    }
